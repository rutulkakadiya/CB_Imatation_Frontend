                    ...
                    <div className="mainDiv grid grid-cols-1 md:grid-cols-12 h-full relative">
                        ...
                        <div className="descriptionDiv flex justify-center items-start sm:items-center md:col-span-8 p-4 md:p-0">
                            <div className="description relative text-center md:text-left">
                                ...
                                <p className='mt-4 absolute right-[10%] bottom-[25%]'>
                                    Let your ears do the talking. Our intricately crafted <br />
                                    earrings are more than just ornaments — they’re expressions <br />
                                ...
                                <div className="custom-pagination absolute bottom-[-10%] left-[0%] border border-white flex items-center gap-3 text-black text-xl font-light z-10">
                                    <div className="custom-prev swiper-button-prev cursor-pointer hover:scale-110 transition-transform duration-200">
                                        {/* <img className='w-[50px]' src="/.svg" alt="" /> */}
                                        <link rel="icon" type="image/svg+xml" href="/left_arrow.svg" />

                                    </div>
                                    <div className="swiper-pagination" />
                                    <div className="custom-next swiper-button-next cursor-pointer hover:scale-110 transition-transform duration-200">
                                        {/* <img className='w-[50px] border border-yellow-400' src="/right_arrow.svg" alt="" /> */}
                                        <link rel="icon" type="image/svg+xml" href="/right_arrow.svg" />
